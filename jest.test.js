...
describe("Execute test: Create a new Game", () => {
  ...
  test("Create a new game from main page when connected", async () => {
    ...
    await driver.wait(until.elementLocated(By.name("createGameButton")), 3000); //Without wait, it continue execution while the page is not loaded
  ...
  test("Search for a game in all games", async () => {
    ...
    await driver.wait(until.elementLocated(By.name("filterButton")), 3000); //Without wait, it continue execution while the page is not loaded
